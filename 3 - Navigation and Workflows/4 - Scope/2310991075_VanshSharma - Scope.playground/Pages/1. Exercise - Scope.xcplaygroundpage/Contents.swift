...
//print("The value of foo is \(foo)")
//line 10 is going to generate an error because the variable foo is mentioned in the for loop . so it will be out of its scope.
...
//this code compiles coz there are two different scopes of x , one local scope in for loop and one global scope .
//foo is defined locally inside for loop
...
greeting(greeting : nil, name: "Vansh")
